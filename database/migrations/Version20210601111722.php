...
class Version20210601111722 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE users (id CHAR(36) NOT NULL COMMENT \'(DC2Type:user_id)\', name_first VARCHAR(255) NOT NULL, name_middle VARCHAR(255) NOT NULL, name_last VARCHAR(255) NOT NULL, role_role VARCHAR(255) NOT NULL, login_login VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE assessments ADD CONSTRAINT FK_4BFCEC0A7941003F FOREIGN KEY (analysis_id) REFERENCES efficiency_analyses (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE efficiency_analyses');
