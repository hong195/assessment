...
class Version20210912071225 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sale_managers CHANGE id id INT NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sale_managers CHANGE id id INT AUTO_INCREMENT NOT NULL');
    }
}
