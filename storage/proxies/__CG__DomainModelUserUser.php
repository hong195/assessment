...
class User extends \App\Domain\Model\User\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Domain\\Model\\User\\User' . "\0" . 'id', '' . "\0" . 'Domain\\Model\\User\\User' . "\0" . 'name', '' . "\0" . 'Domain\\Model\\User\\User' . "\0" . 'role', '' . "\0" . 'Domain\\Model\\User\\User' . "\0" . 'login', '' . "\0" . 'Domain\\Model\\User\\User' . "\0" . 'password'];
        }
