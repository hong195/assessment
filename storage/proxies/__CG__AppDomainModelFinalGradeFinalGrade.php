...
namespace DoctrineProxies\__CG__\App\Domain\Model\FinalGrade;
...
class FinalGrade extends \App\Domain\Model\FinalGrade\FinalGrade implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Domain\\Model\\FinalGrade\\FinalGrade' . "\0" . 'id', '' . "\0" . 'App\\Domain\\Model\\FinalGrade\\FinalGrade' . "\0" . 'assessments', '' . "\0" . 'App\\Domain\\Model\\FinalGrade\\FinalGrade' . "\0" . 'month', '' . "\0" . 'App\\Domain\\Model\\FinalGrade\\FinalGrade' . "\0" . 'scored', '' . "\0" . 'App\\Domain\\Model\\FinalGrade\\FinalGrade' . "\0" . 'total', '' . "\0" . 'App\\Domain\\Model\\FinalGrade\\FinalGrade' . "\0" . 'employeeId', '' . "\0" . 'App\\Domain\\Model\\FinalGrade\\FinalGrade' . "\0" . 'status'];
        }
    ...
    public function editAssessment(\App\Domain\Model\Assessment\AssessmentId $assessmentId, \App\Domain\Model\Assessment\Check $check, array $criteria)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'editAssessment', [$assessmentId, $check, $criteria]);
