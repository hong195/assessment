...
class Option extends \App\Domain\Model\Criterion\Option implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Domain\\Model\\Criterion\\Option' . "\0" . 'id', '' . "\0" . 'Domain\\Model\\Criterion\\Option' . "\0" . 'name', '' . "\0" . 'Domain\\Model\\Criterion\\Option' . "\0" . 'value', '' . "\0" . 'Domain\\Model\\Criterion\\Option' . "\0" . 'criterion'];
        }
