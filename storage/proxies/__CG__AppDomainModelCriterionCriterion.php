...
class Criterion extends \App\Domain\Model\Criterion\Criterion implements \Doctrine\ORM\Proxy\Proxy
{
     ...
     * {@inheritDoc}
     */
    public function findOptionById(\App\Domain\Model\Criterion\OptionId $optionId): ?\App\Domain\Model\Criterion\Option
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'findOptionById', [$optionId]);

        return parent::findOptionById($optionId);
    }
